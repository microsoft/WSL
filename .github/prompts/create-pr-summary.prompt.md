...
4. From the diff, capture impacted WSL areas, key file changes, behavioral risks, migrations, and noteworthy edge cases. Use repo-specific component names when obvious (for example `service`, `wsl`, `init`, `gns`, `plan9`, `docs`, or `distributions`).
