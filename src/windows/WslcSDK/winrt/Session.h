...
struct Session : SessionT<Session>
{
    ...
    winrt::event_token ProcessCrashed(winrt::Microsoft::WSL::Containers::SessionCrashDumpHandler const& handler);
...
private:
    ...
    winrt::event<winrt::Microsoft::WSL::Containers::SessionCrashDumpHandler> m_crashDumpEvent;
