...
struct IOHandleInputStream : winrt::implements<IOHandleInputStream, winrt::Windows::Storage::Streams::IInputStream>
{
...
struct IOHandleOutputStream : winrt::implements<IOHandleOutputStream, winrt::Windows::Storage::Streams::IOutputStream>
{
