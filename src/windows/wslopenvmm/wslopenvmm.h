...
// Destroys *Config and sets it to nullptr. Null Config and null *Config are both accepted.
__declspec(dllimport) void WslOpenVmmDestroyConfig(_Inout_opt_ WslOpenVmmConfig** Config);
