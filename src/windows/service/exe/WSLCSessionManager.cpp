...

        {
            ...
            else
            {
                ...
                m_sessions.push_back(SessionEntry{
                    std::move(createdRef), createdSessionId, createdPid, resolvedDisplayName, std::move(tokenInfo), createdNotifier, false, createdToken, std::move(createdSid), std::move(createdJob)});
