...
public:
    ...
    /// </summary>
    IFACEMETHOD(ImportDistributionInplace)(_In_ LPCWSTR DistributionName, _In_ LPCWSTR VhdPath, _In_ BOOL EnableOobe, _Out_ LXSS_ERROR_INFO* Error, _Out_ GUID* pDistroGuid) override;
...
public:
    ...
    /// </summary>
    HRESULT
    ImportDistributionInplace(_In_ LPCWSTR DistributionName, _In_ LPCWSTR VhdPath, _In_ BOOL EnableOobe, _Out_ GUID* pDistroGuid);
