...
try
{
    ...
    else
    {
        ...
        std::wstring options = L"subname=" + subname;
        if (ReadOnly)
        {
            options += L";ro";
        }
        ...
        // and the vcpus option for the device queue configuration. The options string always
        // begins with "subname=", so it is never empty here.
