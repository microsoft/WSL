...
WSLCVirtualMachineFactory::WSLCVirtualMachineFactory(_In_ const WSLCSessionSettings* Settings, bool UseOpenVmm) : m_useOpenVmm(UseOpenVmm)
{
    THROW_HR_IF(E_POINTER, Settings == nullptr);
...
try
{
    ...
    *Vm = nullptr;
    ...
    if (m_useOpenVmm)
    {
        auto vm = Microsoft::WRL::Make<OpenVmmVirtualMachine>(&settings);
