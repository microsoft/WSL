...
HRESULT GrpcStatusToHresult(int32_t statusCode)
{
    ...
    constexpr int32_t c_grpcInvalidArgument = 3;
    constexpr int32_t c_grpcNotFound = 5;
    constexpr int32_t c_grpcResourceExhausted = 8;
    constexpr int32_t c_grpcUnimplemented = 12;

    switch (statusCode)
    {
    case c_grpcInvalidArgument:
        return E_INVALIDARG;
    case c_grpcNotFound:
        return HRESULT_FROM_WIN32(ERROR_NOT_FOUND);
    case c_grpcResourceExhausted:
        return HRESULT_FROM_WIN32(ERROR_NO_SYSTEM_RESOURCES);
    case c_grpcUnimplemented:
        return E_NOTIMPL;
    default:
        return E_FAIL;
    }
