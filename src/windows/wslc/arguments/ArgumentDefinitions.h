...
_(DeveloperDistribution, "distribution",   NO_ALIAS,         Kind::Value,      NoConversion, Localization::WSLCCLI_DeveloperDistributionArgDescription()) \
_(DeveloperDistro,  "distro",               L"d",             Kind::Value,      NoConversion, Localization::WSLCCLI_DeveloperDistroArgDescription()) \
_(DeveloperEnableGpu, "enable-gpu",         NO_ALIAS,         Kind::Flag,       NoConversion, Localization::WSLCCLI_DeveloperEnableGpuArgDescription()) \
...
_(DeveloperKubeconfigOutput, "output",      L"o",             Kind::Value,      NoConversion, Localization::WSLCCLI_DeveloperKubeconfigOutputArgDescription()) \
