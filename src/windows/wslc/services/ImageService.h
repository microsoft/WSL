...
public:
    ...
    static void Pull(wsl::windows::wslc::models::Session& session, const std::string& image, LPCSTR scheme, IProgressCallback* callback);
    static void Push(wsl::windows::wslc::models::Session& session, const std::string& image, LPCSTR scheme, IProgressCallback* callback);
