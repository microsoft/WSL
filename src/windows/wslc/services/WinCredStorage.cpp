...
void WinCredStorage::Store(const std::string& serverAddress, const std::string& credential)
{
...
std::optional<std::string> WinCredStorage::Get(const std::string& serverAddress)
{
    auto targetName = TargetName(serverAddress);
