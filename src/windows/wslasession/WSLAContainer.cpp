...
void WSLAContainerImpl::Attach(ULONG* Stdin, ULONG* Stdout, ULONG* Stderr)
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to attach to container '%hs'", m_id.c_str());
...
void WSLAContainerImpl::Start(WSLAContainerStartFlags Flags)
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to start container '%hs'", m_id.c_str());
...
void WSLAContainerImpl::Delete()
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to delete container '%hs'", m_id.c_str());
...
void WSLAContainerImpl::Exec(const WSLA_PROCESS_OPTIONS* Options, IWSLAProcess** Process)
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to exec process in container %hs", m_id.c_str());
}
...
void WSLAContainerImpl::Inspect(LPSTR* Output)
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to inspect container '%hs'", m_id.c_str());
}
...
void WSLAContainerImpl::Logs(WSLALogsFlags Flags, ULONG* Stdout, ULONG* Stderr, ULONGLONG Since, ULONGLONG Until, ULONGLONG Tail)
{
    ...
    CATCH_THROW_DOCKER_USER_ERROR("Failed to get logs from '%hs'", m_id.c_str());
