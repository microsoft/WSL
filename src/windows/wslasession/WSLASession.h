...
public:
    ...
    IFACEMETHOD(BuildImage)(_In_ LPCWSTR ContextPath, _In_opt_ LPCSTR DockerfilePath, _In_opt_ LPCSTR ImageTag, _In_opt_ IProgressCallback* ProgressCallback) override;
