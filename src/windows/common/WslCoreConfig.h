...
#define CONFIG_TELEMETRY(c) \
    T_VALUE(c, BestEffortDnsParsing), T_VALUE(c, DhcpTimeout), T_VALUE(c, EnableAutoProxy), T_VALUE(c, EnableDebugConsole), \
        ...
        T_VALUE(c, EnableSparseVhd), T_VALUE(c, EnableVirtio), T_VALUE(c, EnableVirtio9p), T_VALUE(c, EnableVirtioFs), T_VALUE(c, VirtioFsDaxSize), \
...
namespace ConfigSetting {
    ...
    static constexpr auto VirtiofsDaxSize = "wsl2.virtiofsDaxSize";
