...
#define WSLC_ARGUMENTS(_) \
    ...
    _(Info,         "info",         L'i',           Localization::WSLCCLI_InfoArgDescription(),           (bool),                       Kind::Standard,    Visibility::Help,    false, 1, Category::None, ExclusiveSet::None) \
    ...
    _(ForwardArgs,  "",             NoAlias,        L"Test Arg for now",                                  (std::vector<std::wstring>),  Kind::Positional,  Visibility::Example, false, 30, Category::None, ExclusiveSet::None) \
    ...
    _(TestArg,      "arg",          L'a',           L"Shows Ninjacat",                                    (bool),                       Kind::Standard,    Visibility::Help,    true,  1, Category::None, ExclusiveSet::None)