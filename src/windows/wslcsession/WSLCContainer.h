...
public:
    ...
    void Attach(LPCSTR DetachKeys, HANDLE* TtySocket, HANDLE* Stdin, HANDLE* Stdout, HANDLE* Stderr) const;
    void Stop(_In_ WSLCSignal Signal, _In_ LONG TimeoutSeconds);
    void Delete(WSLCDeleteFlags Flags);
    void Export(HANDLE TarHandle) const;
    ...
    void Logs(WSLCLogsFlags Flags, HANDLE* Stdout, HANDLE* Stderr, ULONGLONG Since, ULONGLONG Until, ULONGLONG Tail) const;
...
public:
    ...
    IFACEMETHOD(Attach)(_In_opt_ LPCSTR DetachKeys, _Out_ HANDLE* TtySocket, _Out_ HANDLE* Stdin, _Out_ HANDLE* Stdout, _Out_ HANDLE* Stderr) override;
    ...
    IFACEMETHOD(Export)(_In_ HANDLE TarHandle) override;
    ...
    IFACEMETHOD(Logs)(_In_ WSLCLogsFlags Flags, _Out_ HANDLE* Stdout, _Out_ HANDLE* Stderr, _In_ ULONGLONG Since, _In_ ULONGLONG Until, _In_ ULONGLONG Tail) override;
