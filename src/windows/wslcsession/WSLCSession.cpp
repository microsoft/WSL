...
try
{
    ...
    auto requestContext = runtime.Docker().PullImage(repo, tagOrDigest, registryAuth);
...
try
{
    ...
    auto requestContext = m_runtime.Docker().PushImage(repo, tagOrDigest, RegistryAuthenticationInformation);
