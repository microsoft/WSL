...
ExecStart=/bin/mount -o bind,ro,X-mount.mkdir -t none /mnt/wslg/.X11-unix /tmp/.X11-unix)";
        ...
        if (interopEnabled && protectBinfmt)
        {
            ...
            constexpr auto* serviceOverrideContent = R"(# Note: This file is generated by WSL to prevent distributions from removing the WSL binfmt entry on shutdown.
...
Options=nosuid,nodev,noexec
            ...
            // Install the override for systemd-binfmt.service.
            {
                ...
                THROW_LAST_ERROR_IF(WriteToFile(std::format("{}/override.conf", overrideFolder).c_str(), serviceOverrideContent) < 0);
            }
