...
COMMAND_LINE_TEST_CASE(L"image build C:\\context --progress plain", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context -t test --build-arg KEY=VALUE --progress plain", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context --no-cache", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context --no-cache --progress tty", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context --progress auto", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context --progress quiet", L"build", true)
COMMAND_LINE_TEST_CASE(L"image build C:\\context --progress bogus", L"build", false)
