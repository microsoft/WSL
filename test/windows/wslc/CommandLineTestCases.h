...
COMMAND_LINE_TEST_CASE(L"system events --filter network=test", L"events", false)
COMMAND_LINE_TEST_CASE(L"system events --filter type=container -f label=env=prod", L"events", false)
COMMAND_LINE_TEST_CASE(L"system events --filter container=test --filter image=debian:latest", L"events", true)
COMMAND_LINE_TEST_CASE(L"system events --filter =test", L"events", false)
...
COMMAND_LINE_TEST_CASE(L"events --filter network=test", L"events", false)
COMMAND_LINE_TEST_CASE(L"events --filter type=container -f label=env=prod", L"events", false)
COMMAND_LINE_TEST_CASE(L"events --filter container=test --filter image=debian:latest", L"events", true)
COMMAND_LINE_TEST_CASE(L"events --filter =test", L"events", false)
...
COMMAND_LINE_TEST_CASE(L"container run --restart no ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart always ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart on-failure ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart on-failure:3 ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart unless-stopped ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart always:0 ubuntu", L"run", true)
COMMAND_LINE_TEST_CASE(L"container run --restart invalid ubuntu", L"run", false)
COMMAND_LINE_TEST_CASE(L"container run --restart on-failure:-1 ubuntu", L"run", false)
COMMAND_LINE_TEST_CASE(L"container run --restart always:1 ubuntu", L"run", false)
COMMAND_LINE_TEST_CASE(L"container run --restart always --rm ubuntu", L"run", false)
COMMAND_LINE_TEST_CASE(L"container run --restart no --rm ubuntu", L"run", true)
...
COMMAND_LINE_TEST_CASE(L"container create --restart no ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart always ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart on-failure ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart on-failure:3 ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart unless-stopped ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart always:0 ubuntu", L"create", true)
COMMAND_LINE_TEST_CASE(L"container create --restart invalid ubuntu", L"create", false)
COMMAND_LINE_TEST_CASE(L"container create --restart on-failure:-1 ubuntu", L"create", false)
COMMAND_LINE_TEST_CASE(L"container create --restart always:1 ubuntu", L"create", false)
COMMAND_LINE_TEST_CASE(L"container create --restart always --rm ubuntu", L"create", false)
COMMAND_LINE_TEST_CASE(L"container create --restart no --rm ubuntu", L"create", true)
