...
COMMAND_LINE_TEST_CASE(L"container list --size=true", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list --size=false", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list --size=invalid", L"list", false)
COMMAND_LINE_TEST_CASE(L"container list -as", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list --size --no-trunc", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list -s -q", L"list", true)
COMMAND_LINE_TEST_CASE(L"container list --size extra", L"list", false) // ps takes no positional arguments
