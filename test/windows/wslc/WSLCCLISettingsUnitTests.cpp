...
class WSLCCLISettingsUnitTests
{
    ...
    TEST_METHOD(LoadSettings_EmptySettings_WarnsInvalidStructure)
    {
        ...
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidStructure(), s.GetWarnings().front().Message);
        VERIFY_ARE_EQUAL(0u, s.Get<Setting::SessionCpuCount>());
        VERIFY_ARE_EQUAL(0u, s.Get<Setting::SessionMemoryMb>());
        VERIFY_ARE_EQUAL(1048576u, s.Get<Setting::SessionStorageSizeMb>());
    }
    ...
    TEST_METHOD(Validation_CpuCount_Zero_UsesDefaultAndWarns)
    {
        ...
        VERIFY_ARE_EQUAL(0u, s.Get<Setting::SessionCpuCount>());
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"session.cpuCount", 2), s.GetWarnings().front().Message);
    ...
    TEST_METHOD(Validation_MemoryMb_Zero_UsesDefaultAndWarns)
    {
        ...
        VERIFY_ARE_EQUAL(0u, s.Get<Setting::SessionMemoryMb>());
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"session.memorySize", 2), s.GetWarnings().front().Message);
    }
    ...
    TEST_METHOD(Validation_StorageSizeMb_Zero_UsesDefaultAndWarns)
    {
        ...
        VERIFY_ARE_EQUAL(1048576u, s.Get<Setting::SessionStorageSizeMb>());
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"session.maxStorageSize", 2), s.GetWarnings().front().Message);
    }
    ...
    TEST_METHOD(Validation_WrongType_UsesDefaultAndWarns)
    {
        ...
        VERIFY_ARE_EQUAL(0u, s.Get<Setting::SessionCpuCount>());
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidType(L"session.cpuCount", 2), s.GetWarnings().front().Message);
    }
    ...
    TEST_METHOD(Validation_DefaultString_IsCaseSensitive)
    {
        ...
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"session.networkingMode", 2), s.GetWarnings()[0].Message);
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"credentialStore", 3), s.GetWarnings()[1].Message);
    ...
    TEST_METHOD(Validation_CredentialStore_Invalid_UsesDefaultAndWarns)
    {
        ...
        VERIFY_ARE_EQUAL(static_cast<int>(CredentialStoreType::WinCred), static_cast<int>(s.Get<Setting::CredentialStore>()));
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_InvalidValue(L"credentialStore", 1), s.GetWarnings().front().Message);
    }
    ...
    TEST_METHOD(Validation_UnknownKeys_WarnsAboutUnknownKeys)
    {
        ...
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_UnknownSection(L"unknownSection", 4), s.GetWarnings()[0].Message);
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_UnknownKey(L"session.unknownSetting", 3), s.GetWarnings()[1].Message);
    }
    ...
    TEST_METHOD(Validation_UnknownKeys_UnknownInKnownSection)
    {
        ...
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_UnknownKey(L"session.typoSetting", 3), s.GetWarnings().front().Message);
    ...
    TEST_METHOD(Validation_UnknownKeys_UnknownRootSection)
    {
        ...
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_UnknownSection(L"badSection", 1), s.GetWarnings().front().Message);
    ...
    TEST_METHOD(Validation_UnknownKeys_UnknownRootScalar)
    {
        ...
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_UnknownKey(L"badKey", 3), s.GetWarnings().front().Message);
    ...
    TEST_METHOD(Validation_UnknownKeys_ComplexKey_WarnsNonStringKey)
    {
        ...
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_NonStringKey(L"session", 3), s.GetWarnings().front().Message);
    ...
    TEST_METHOD(Validation_UnknownKeys_ComplexKeyAtRoot_WarnsNonStringKey)
    {
        ...
        VERIFY_ARE_EQUAL(1u, s.GetWarnings().size());
        VERIFY_ARE_EQUAL(Loc::WSLCUserSettings_Warning_NonStringKey(L"root", 1), s.GetWarnings().front().Message);
