...
The collected logs include WSLg (graphical and audio application) logs from `/mnt/wslg` and any WSLg crash dumps, so the same script covers graphical-app issues.
