...
- Reporting of issues found within and when using the Windows Subsystem for Linux.
  Please read [CONTRIBUTING.md](https://github.com/Microsoft/WSL/blob/master/CONTRIBUTING.md) before submitting an issue.
...
Note that WSL distro's launch in the Windows Console (unless you have taken steps to launch a third-party console/terminal). Therefore, *please file UI/UX related issues in the [Windows Console issue tracker](https://github.com/microsoft/console)*. 

## Labels:

This is your best way to interact directly with the Windows Subsystem for Linux teams. We will be monitoring and responding to issues as best we can. Please try to avoid filing duplicates of open or closed items whenever possible. Issues may be tagged with with the following labels:
